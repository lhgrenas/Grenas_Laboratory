...
//Derived class: CurrentAccount (not defined in original code, added for completeness)
...
public class OOP {
    public static void main(String[] args) {
        ...
        SavingsAccount savings = new SavingsAccount("Pibi", 1000, 5); // Fixed 'SavingAccount' typo
        ...
        CurrentAccount current = new CurrentAccount("Labi", 2000, 1000); // Fixed extra backslash
